...
**本项目已正式进入 0.17 版本，0.16 及 0.15 版本请进入下方的「下载页面」下载对应版本。**


### 下载页面：

* [GitHub 下载页面](https://github.com/Ludeon/RimWorld-ChineseSimplified/releases)
* [Coding 下载页面](https://coding.net/u/duduluu/p/RimWorld-ChineseSimplified/git/tags)
